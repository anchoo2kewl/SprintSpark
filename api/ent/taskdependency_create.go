...
func (_c *TaskDependencyCreate) SetTaskID(v int64) *TaskDependencyCreate {
	_c.mutation.SetTaskID(v)
	return _c
}

// SetDependsOnID sets the "depends_on_id" field.
func (_c *TaskDependencyCreate) SetDependsOnID(v int64) *TaskDependencyCreate {
...
func (_c *TaskDependencyCreate) SetID(v int64) *TaskDependencyCreate {
	_c.mutation.SetID(v)
	return _c
}
...
func (_c *TaskDependencyCreate) createSpec() (*TaskDependency, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(taskdependency.Table, sqlgraph.NewFieldSpec(taskdependency.FieldID, field.TypeInt64))
	)
