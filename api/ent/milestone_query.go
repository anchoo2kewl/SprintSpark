...
func (_q *MilestoneQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *MilestoneQuery) FirstIDX(ctx context.Context) int64 {
...
func (_q *MilestoneQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (_q *MilestoneQuery) OnlyIDX(ctx context.Context) int64 {
...
func (_q *MilestoneQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (_q *MilestoneQuery) IDsX(ctx context.Context) []int64 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(milestone.FieldProjectID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Milestone.Query().
//		Select(milestone.FieldProjectID).
//		Scan(ctx, &v)
...
func (_q *MilestoneQuery) loadProject(ctx context.Context, query *ProjectQuery, nodes []*Milestone, init func(*Milestone), assign func(*Milestone, *Project)) error {
	...
	nodeids := make(map[int64][]*Milestone)
	for i := range nodes {
...
func (_q *MilestoneQuery) loadTasks(ctx context.Context, query *TaskQuery, nodes []*Milestone, init func(*Milestone), assign func(*Milestone, *Task)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(task.FieldMilestoneID)
	}
	...
	for _, n := range neighbors {
		fk := n.MilestoneID
		if fk == nil {
			return fmt.Errorf(`foreign-key "milestone_id" is nil for node %v`, n.ID)
		}
		node, ok := nodeids[*fk]
		if !ok {
...
func (_q *MilestoneQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(milestone.Table, milestone.Columns, sqlgraph.NewFieldSpec(milestone.FieldID, field.TypeInt64))
	_spec.From = _q.sql
