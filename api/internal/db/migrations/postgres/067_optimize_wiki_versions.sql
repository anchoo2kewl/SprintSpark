...
ALTER TABLE wiki_page_versions ADD COLUMN IF NOT EXISTS content_encoding TEXT NOT NULL DEFAULT 'plain';
ALTER TABLE wiki_page_versions ADD COLUMN IF NOT EXISTS content_compressed BYTEA;
